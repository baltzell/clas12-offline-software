 ...
 * calculated with respect to the specified line
 * @author heddle, devita
 *
 */
public class DefaultRhoAxisStopper implements IStopper {
	 ...
	 * @param sMax            maximal path length in meters
         * @param rho0            current rho
	 * @param targetRho       stopping rho in meters
         * @param line            cylinder axis
	 * @param accuracy        the accuracy in meters
	 */
	public DefaultRhoAxisStopper(double[] uo, double s0, double sMax, double rho0, double targetRho, Line line, double accuracy) {
	...
	public boolean stopIntegration(double s, double[] u) {
		...
		_currentRho = _line.distanceToLine(u[0], u[1], u[2]);
		_totS = s;
